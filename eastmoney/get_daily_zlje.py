...
if __name__ == '__main__':
    ...
    df.to_csv('csv_data/zlje_1.csv', encoding='gbk')
    df_3.to_csv('csv_data/zlje_3.csv', encoding='gbk')
    df_5.to_csv('csv_data/zlje_5.csv', encoding='gbk')
    df_10.to_csv('csv_data/zlje_10.csv', encoding='gbk')
